...
RSpec.describe Plunk::Mail do
  describe '.from_message' do
    ...
    let(:message_params) do
      {
        from: 'Plunk Test <plunk@plunk.io>',
        to: 'To 1 <to_1@test.com>, to_2@test.com',
        cc: 'cc_1@test.com, Cc 2 <cc_2@test.com>',
        ...
        let(:expected_headers) do
          {
            ...
            'Reply-To' => 'Reply To <reply-to@test.com>',
            'One-more-custom-header' => 'CustomValue'
          }
        end

        before do
          message.reply_to = 'Reply To <reply-to@test.com>'
